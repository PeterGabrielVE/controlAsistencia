...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::resource('asistencia', 'AsistenciaController')->middleware('has.role:super,supervisor,jefe');
	// home
    ...
    Route::get('asistencia/edit/{id}', 'AsistenciaController@edit')->name('asistencia.edit')->middleware('has.role:super,supervisor,jefe');
