@extends('layouts.app')
@section('title')
<h1 class="nav-title text-white"> Configuración > <i class="icon icon-documents3 text-blue s-18"></i>PLANIFICADORES</h1>
@endsection
@section('maincontent')
                ...
                <div class="card-body">
                    ...
                    <div class="form-row"> 
                            <div class="form-group col-4 m-0">
								...
								{!! Form::text('descripcion', null, ['class'=>'form-control r-0 light s-12','id'=>'descripcion','required']) !!}
